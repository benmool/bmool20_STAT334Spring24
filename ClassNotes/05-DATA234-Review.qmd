...
What should we change or add?
  ...
  * exclude majors that do not meet the cut off for total M + F and do not fairly represent the major (we will only include majors with >= 70 students)
      * make a df with the count for each major
      * filter it to keep n_major >= 70
      * semi_join() 
